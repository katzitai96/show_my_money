                        ...
                        (_a = scrapeResult.accounts) === null || _a === void 0 ? void 0 : _a.forEach(function (account) {
                            ...
                            account.txns.forEach(function (transaction) {
                                ...
                                if (d.getMonth() + 1 == month && d.getFullYear() == year && notCreditCard(transaction.description)) {
                                    var category = findCategory(transaction.description, transaction.category, transaction.originalAmount);
                                    console.log(transaction.description, transaction.originalAmount, "".concat(d.getFullYear(), "-").concat(d.getMonth() + 1, "-").concat(d.getDate()), category);
...
function findCategory(description, category, amount) {
    ...
    else if (category.includes("רשתות שווק מזון") ||
